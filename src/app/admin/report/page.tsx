...
export default function AdminReport() {
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-4 h-full">
      <div className="lg:col-span-1 max-h-full overflow-auto w-full bg-white/20 backdrop-blur-md rounded-lg p-4 relative">
        <ArrowBackComp
          href="/admin"
      ...
      <div className="lg:col-span-2 overflow-auto bg-white/20 backdrop-blur-md rounded-lg flex justify-center p-4">
