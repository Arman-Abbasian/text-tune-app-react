...
import { useGetFilteredTrainingVoicesQuery } from '../../services/User'

const UserVoiceTable = () => {
  const {
    data: GetFilteredTrainingVoicesQuery,
    isLoading: GetFilteredTrainingVoicesQueryLoading,
  } = useGetFilteredTrainingVoicesQuery()

  console.log(GetFilteredTrainingVoicesQuery)
  return (
